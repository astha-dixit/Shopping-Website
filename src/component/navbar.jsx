...
<Box className={styles.logo}>
    <Link to='/' ><Image height={24} width={24} src="https://img.freepik.com/free-vector/letter-e-logo-icon-colorfuell_125964-396.jpg?w=2000"/></Link>
</Box>
<Menu  >
  ...
  >
   <Link to='/products/women' > <MenuItem> Women</MenuItem></Link>
   <Link to='/products/men' > <MenuItem>Men</MenuItem></Link>
   <Link to='/products/women' ><MenuItem>Girls</MenuItem></Link>
   <Link to='/products/men' > <MenuItem>Boys</MenuItem></Link>
...
<Box border={'1px solid skyblue'}  p="0px 0px 0px 5px" className={styles.input} ><i className="fa-solid fa-magnifying-glass"></i><Input placeholder="What are you looking for?" border={'none'} outline={"none"}   /></Box>
<Box>
{state.isAuth?<Menu>
